<tr x-data="{ modalIsOpen : false }">
    ...
    @if(getCrudConfig('Student')->delete or getCrudConfig('Student')->update)
        <td>
            ...
            @if(getCrudConfig('Student')->update && hasPermission(getRouteName().'.student.update', 1, 1, $student))
                <a href="@route(getRouteName().'.student.update', $student->id)" class="btn text-primary mt-1">
                    <i class="icon-pencil"></i>
                </a>
            @endif

            @if(getCrudConfig('Student')->delete && hasPermission(getRouteName().'.student.delete', 1, 1, $student))
